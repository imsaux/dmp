...
PNG_PALETTE = [[254, 254, 254], [128, 0, 0], [0, 128, 0], [128, 128, 0], [0, 0, 128], [128, 0, 128], [0, 128, 128],
               [218, 178, 115], [192, 220, 192], [166, 202, 240], [10, 10, 10], [11, 11, 11], [12, 12, 12],
               ...
               [97, 97, 97], [98, 98, 98], [99, 99, 99], [100, 100, 100], [101, 101, 101], [102, 102, 102],
               [103, 103, 103], [104, 104, 104], [105, 105, 105], [106, 106, 106], [107, 107, 107], [108, 108, 108],
               [109, 109, 109], [110, 110, 110], [111, 111, 111], [112, 112, 112], [113, 113, 113], [114, 114, 114],
               [115, 115, 115], [116, 116, 116], [117, 117, 117], [118, 118, 118], [119, 119, 119], [120, 120, 120],
               [121, 121, 121], [122, 122, 122], [123, 123, 123], [124, 124, 124], [125, 125, 125], [126, 126, 126],
               [127, 127, 127], [128, 128, 128], [129, 129, 129], [130, 130, 130], [131, 131, 131], [132, 132, 132],
               [133, 133, 133], [134, 134, 134], [135, 135, 135], [136, 136, 136], [137, 137, 137], [138, 138, 138],
               [139, 139, 139], [140, 140, 140], [141, 141, 141], [142, 142, 142], [143, 143, 143], [144, 144, 144],
               [145, 145, 145], [146, 146, 146], [147, 147, 147], [148, 148, 148], [149, 149, 149], [150, 150, 150],
               [151, 151, 151], [152, 152, 152], [153, 153, 153], [154, 154, 154], [155, 155, 155], [156, 156, 156],
               [157, 157, 157], [158, 158, 158], [159, 159, 159], [160, 160, 160], [161, 161, 161], [162, 162, 162],
               [163, 163, 163], [164, 164, 164], [165, 165, 165], [166, 166, 166], [167, 167, 167], [168, 168, 168],
               [169, 169, 169], [170, 170, 170], [171, 171, 171], [172, 172, 172], [173, 173, 173], [174, 174, 174],
               [175, 175, 175], [176, 176, 176], [177, 177, 177], [178, 178, 178], [179, 179, 179], [180, 180, 180],
               ...
               [193, 193, 193], [194, 194, 194], [195, 195, 195], [196, 196, 196], [197, 197, 197], [198, 198, 198],
               [199, 199, 199], [200, 200, 200], [201, 201, 201], [202, 202, 202], [203, 203, 203], [204, 204, 204],
               [205, 205, 205], [206, 206, 206], [207, 207, 207], [208, 208, 208], [209, 209, 209], [210, 210, 210],
               [211, 211, 211], [212, 212, 212], [213, 213, 213], [214, 214, 214], [215, 215, 215], [216, 216, 216],
               [217, 217, 217], [218, 218, 218], [219, 219, 219], [220, 220, 220], [221, 221, 221], [222, 222, 222],
               [223, 223, 223], [224, 224, 224], [225, 225, 225], [226, 226, 226], [227, 227, 227], [228, 228, 228],
               [229, 229, 229], [230, 230, 230], [231, 231, 231], [232, 232, 232], [233, 233, 233], [234, 234, 234],
               [235, 235, 235], [236, 236, 236], [237, 237, 237], [238, 238, 238], [239, 239, 239], [240, 240, 240],
               [241, 241, 241], [242, 242, 242], [243, 243, 243], [244, 244, 244], [245, 245, 245], [246, 246, 246],
               [247, 247, 247], [248, 248, 248], [249, 249, 249], [250, 250, 250], [251, 251, 251], [252, 252, 252],
...
def linear_transformation(path_to_image, count, path_to_new_image):
    ...
    if mode == 'L':
        ...
        for c in range(count):
            new_img_path = os.path.normpath(os.path.join(path_to_new_image, path_to_image[:-4] + '_%s_%s_%s.jpg' % (
            'linear_transformation', mode, c)))
...
def non_linear_transformation(path_to_image, count, path_to_new_image):
    ...
    if mode == 'L':
        ...
        for c in range(count):
            new_img_path = os.path.normpath(os.path.join(path_to_new_image, path_to_image[:-4] + '_%s_%s_%s.jpg' % (
            'non_linear_transformation', mode, c)))
            total_pix = img.width * img.height
            for i in range(img.width):
                for j in range(img.height):
                    if pixel[i, j] > mean:
        ...
        for j in range(count):
            ...
            r = imgr.copy()
            new_img_path = os.path.normpath(os.path.join(path_to_new_image, path_to_image[:-4] + '_%s_%s_%s.jpg' % (
            'non_linear_transformation', mode, j)))
            total_pix = w * h
            for r2 in range(0, w):
                for c2 in range(0, h):
...
def imnoise(path_to_image, count, path_to_new_image):
    ...
    if mode == 'L':
        ...
        for c in range(count):
            new_img_path = os.path.normpath(
                os.path.join(path_to_new_image, path_to_image[:-4] + '_%s_%s_%s.jpg' % ('imnoise', mode, c)))
...
def denoise(path_to_image, count, path_to_new_image):
    ...
    if mode == 'L':
        ...
        for c in range(count):
            new_img_path = os.path.normpath(
                os.path.join(path_to_new_image, path_to_image[:-4] + '_%s_%s_%s.jpg' % ('denoise', mode, c)))
