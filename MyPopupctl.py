...
class MyPopupControl(wx.Control):
    def __init__(self,*_args,**_kwargs):
        ...
        self.bCtrl = MyPopButton(self, wx.ID_ANY, style=wx.BORDER_NONE)
        self.pop = None
        self.content = None
    ...
    def OnButton(self, evt):
        if not self.pop:
            if self.content:
                self.pop = MyPopupDialog(self,self.content)
                del self.content
            else:
